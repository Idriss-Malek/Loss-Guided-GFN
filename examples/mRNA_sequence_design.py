...
from src.envs.mRNA_codon_env import CodonDesignEnv
from mRNA_design_utils.utils import *
...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_path', type=str, default="examples/mRNA_design_utils/config.yaml")
